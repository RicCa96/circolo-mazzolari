                ...
                <div className="mt-10 grid gap-8 lg:grid-cols-2">
                    <div className="space-y-8">
                        ...
                        <div className="rounded-3xl bg-white p-8 shadow-sm border border-primary/10">
                            <h3 className="text-2xl font-bold text-primary mb-4">Costi per il 2026</h3>
                            <p className="text-sm text-neutral-500 mb-6 italic">(Costo invariato rispetto al 2025)</p>
                            <ul className="space-y-3">
                                <li className="flex items-center justify-between p-4 rounded-2xl bg-primary/5">
                                    <span className="font-bold text-primary">Adulti</span>
                                    <span className="text-2xl font-black text-primary">10 €</span>
                                </li>
                                <li className="flex items-center justify-between p-4 rounded-2xl bg-primary/5">
                                    <div className="flex flex-col">
                                        <span className="font-bold text-primary">Ragazzi</span>
                                        <span className="text-xs text-neutral-500">(entro i 18 anni non compiuti)</span>
                                    </div>
                        ...
                        <div className="rounded-3xl bg-white p-8 shadow-sm border border-secondary/20 bg-secondary/5">
                            ...
                            <p className="text-neutral-600 mb-6">L’adesione può essere fatta mediante bonifico bancario:</p>
                            <div className="bg-white p-4 rounded-xl border border-secondary/20 font-mono text-sm break-all mb-4">
                                <p className="mb-1 text-neutral-400 uppercase font-sans font-bold tracking-wider text-xs">IBAN</p>
                                <div className="flex justify-between items-center">
                                    <span className="text-secondary font-bold">IT90 D 05034 66420 000000023254</span>
                    ...
                    <div className="rounded-3xl bg-white p-8 shadow-sm border border-primary/10">
                        ...
                        <ol className="space-y-6">
                            <li className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-neutral-600 text-sm mb-2">Scarica il modulo per la richiesta di adesione:</p>
                            ...
                            <li className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-neutral-600 text-sm">Compila il modulo in ogni sua parte e apponi firme olografe (per i minori è necessaria la firma di un genitore/tutore).</p>
                                </div>
                            </li>
                            <li className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-neutral-600 text-sm mb-2">Invia il modulo compilato e firmato all&apos;indirizzo:</p>
                        ...
                        <div className="mt-8 pt-6 border-t border-neutral-100">
                            <p className="text-xs text-neutral-500 leading-relaxed">
                                ...
                                da <span className="font-medium text-neutral-700">Tesseramento ANSPI</span> &lt;tessera@anspi.it&gt; una
