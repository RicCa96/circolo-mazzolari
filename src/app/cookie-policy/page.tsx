...
export default function CookiePolicyPage() {
    return (
        <section className="bg-gradient-to-b from-blue-50 to-white py-14 md:py-20 border-b border-primary/10">
            <JsonLd data={breadcrumbsJsonLd([{name: "Cookie Policy", path: "/cookie-policy"}])}/>
            <Container>
                <SectionTitle
                    kicker="Legale"
                ...
                <div className="mt-10 bg-white p-8 rounded-3xl border border-primary/10 shadow-lg space-y-8">
                    <div>
                        <h2 className="text-xl font-bold text-primary mb-4">Cosa sono i cookie</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-primary mb-4">Cookie tecnici (Necessari)</h2>
                        <p className="text-neutral-600">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-primary mb-4">Cookie di terze parti</h2>
                        <p className="text-neutral-600">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-primary mb-4">Come gestire i cookie</h2>
                        <p className="text-neutral-600">
